...
<div className="hidden sm:inline">
      ...
      <div className="relative px-4 pt-2 sm:px-6 lg:px-8">
        ...
        <div 
          className="mt-6 prose dark:prose-invert prose-a:no-underline hover:prose-a:underline prose-purple dark:prose-purple-400 prose-ul:text-gray-700 dark:prose-ul:text-gray-300 prose-lg mx-auto ease-in duration-300" 
